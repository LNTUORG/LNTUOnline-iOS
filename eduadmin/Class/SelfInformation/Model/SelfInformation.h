...
@property (nonatomic,copy) NSString *dateOfAdmission; // 入学日期
@property (nonatomic,copy) NSString *dateOfGraduation; // 毕业日期
@property (nonatomic,copy) NSString *homeAddress; // 家庭住址
@property (nonatomic,copy) NSString *contactTel; // 联系电话
...
@property (nonatomic,copy) NSString *dateOfBirth; // 生日
